...
if __name__ == "__main__":
    os.system(
        "python3 utils/cutter.py --input /input --output data/cutted")
    os.system(
        "python3 test.py --gpu 0 --config config/model.config --checkpoint data/model/model/31.pkl --result result.json")
    result = {}

...
PRETRAINED_VOCAB_FILES_MAP = {
    "vocab_file": {
        "chinese-electra-180g-small-discriminator": "D:/pre-train/chinese-electra-180g-small-discriminator/vocab.txt",
...
PRETRAINED_POSITIONAL_EMBEDDINGS_SIZES = {
    "chinese-electra-180g-small-discriminator": 512,  # 不知道对不对,先和其他的写成一样的
...
PRETRAINED_INIT_CONFIGURATION = {
    "chinese-electra-180g-small-discriminator": {"do_lower_case": True},  # 不知道对不对,先和其他的写成一样的
